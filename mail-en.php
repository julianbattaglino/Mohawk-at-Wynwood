...
if (!$response->isSuccess()) {
    echo "<script> alert('Error: The reCAPTCHA v3 token is invalid, please try again.');
    ...
    if ($score < 0.7) {
        echo "<script> alert('Error: reCAPTCHA v3 score is too low, try again.');
             window.location.href = 'index-en.html';
             </script>";
    } else {
        ...
        try {
            ...
            echo "
    <script> alert('Thank you for contacting us. We will respond as soon as possible.');
    window.location.href = 'index-en.html';
    </script>";
        } catch (Exception $e) {
            echo "
    <script> alert('There was an error, the message could not be sent, please try again.');
    window.location.href = 'index-en.html';
    </script>";
        }
    }
